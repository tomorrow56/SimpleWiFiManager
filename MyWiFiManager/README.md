...
MyWiFiManager provides an easy way to configure WiFi credentials for ESP8266/ESP32 devices using a captive portal. The library features a modular design with separated WebUI components for better maintainability and customization.
